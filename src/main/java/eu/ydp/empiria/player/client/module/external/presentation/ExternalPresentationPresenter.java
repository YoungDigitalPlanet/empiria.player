...
import eu.ydp.empiria.player.client.module.external.presentation.view.ExternalPresentationView;
...
public class ExternalPresentationPresenter implements ExternalFrameLoadHandler<ExternalApi> {
	...
	private final ExternalPresentationView view;
	...
	@Inject
	public ExternalPresentationPresenter(ExternalStateEncoder stateEncoder, ExternalPresentationView view,
