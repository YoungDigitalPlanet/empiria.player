...
public interface InlineBodyGeneratorFactory {
    ...
    InlineBodyGenerator createInlineBodyGenerator(ModulesRegistrySocket mrs, ModuleSocket moduleSocket, DisplayContentOptions options, ParenthoodManager parenthood);
}
