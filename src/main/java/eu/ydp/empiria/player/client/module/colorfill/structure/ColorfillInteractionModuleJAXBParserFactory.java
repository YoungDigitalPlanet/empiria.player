...
@JAXBBindings(value = ColorfillInteractionBean.class, objects = { ButtonsContainer.class, ColorButton.class, EraserButton.class, AreaContainer.class,
		Area.class, Image.class, FakeAreas.class })
