...
import eu.ydp.empiria.player.client.controller.ItemStyleNameConstants;
import eu.ydp.empiria.player.client.controller.Page;
import eu.ydp.empiria.player.client.controller.assets.AssetOpenDelegatorService;
import eu.ydp.empiria.player.client.controller.body.BodyStyleNameConstants;
...
import eu.ydp.empiria.player.client.controller.extensions.internal.bookmark.BookmarkStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.audioplayer.AudioPlayerStyleNameConstants;
import eu.ydp.empiria.player.client.module.bonus.BonusStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.containers.TextInteractionStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.external.common.ExternalStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.info.InfoStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.link.LinkStyleNameConstants;
import eu.ydp.empiria.player.client.module.math.MathStyleNameConstants;
import eu.ydp.empiria.player.client.module.mathjax.MathJaxStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.progressbonus.ProgressBonusStyleNameConstants;
...
import eu.ydp.empiria.player.client.module.simpletext.SimpleTextStyleNameConstants;
import eu.ydp.empiria.player.client.module.simulation.SimulationStyleNameConstants;
import eu.ydp.empiria.player.client.module.slideshow.SlideshowStyleNameConstants;
import eu.ydp.empiria.player.client.module.sourcelist.SourceListStyleNameConstants;
import eu.ydp.empiria.player.client.module.span.SpanStyleNameConstants;
import eu.ydp.empiria.player.client.module.speechscore.SpeechScoreStyleNameConstants;
import eu.ydp.empiria.player.client.module.table.TableStyleNameConstants;
...
public class PlayerGinModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(StickieStyleNameConstants.class).in(Singleton.class);
        bind(ConnectionStyleNameConstants.class).in(Singleton.class);
        bind(ColorfillStyleNameConstants.class).in(Singleton.class);
        bind(AudioPlayerStyleNameConstants.class).in(Singleton.class);
        bind(DrawingStyleNameConstants.class).in(Singleton.class);
        bind(ImgStyleNameConstants.class).in(Singleton.class);
        bind(MediaStyleNameConstants.class).in(Singleton.class);
        bind(ButtonStyleNameConstants.class).in(Singleton.class);
        bind(TextEntryStyleNameConstants.class).in(Singleton.class);
        bind(ModeStyleNameConstants.class).in(Singleton.class);
        bind(InlineChoiceStyleNameConstants.class).in(Singleton.class);
        bind(LabellingStyleNameConstants.class).in(Singleton.class);
        bind(InfoStyleNameConstants.class).in(Singleton.class);
        bind(SpanStyleNameConstants.class).in(Singleton.class);
        bind(ItemStyleNameConstants.class).in(Singleton.class);
        bind(TextInteractionStyleNameConstants.class).in(Singleton.class);
        bind(MathJaxStyleNameConstants.class).in(Singleton.class);
        bind(ReportStyleNameConstants.class).in(Singleton.class);
        bind(MathStyleNameConstants.class).in(Singleton.class);
        bind(ProgressBonusStyleNameConstants.class).in(Singleton.class);
        bind(BodyStyleNameConstants.class).in(Singleton.class);
        bind(DragGapStyleNameConstants.class).in(Singleton.class);
        bind(SlideshowStyleNameConstants.class).in(Singleton.class);
        bind(SpeechScoreStyleNameConstants.class).in(Singleton.class);
        bind(PageStyleNameConstants.class).in(Singleton.class);
        bind(SourceListStyleNameConstants.class).in(Singleton.class);
        bind(DictionaryStyleNameConstants.class).in(Singleton.class);
        bind(SelectionStyleNameConstants.class).in(Singleton.class);
        bind(FeedbackStyleNameConstants.class).in(Singleton.class);
        bind(LinkStyleNameConstants.class).in(Singleton.class);
        bind(AccordionStyleNameConstants.class).in(Singleton.class);
        bind(BookmarkStyleNameConstants.class).in(Singleton.class);
        bind(TestStyleNameConstants.class).in(Singleton.class);
        bind(TableStyleNameConstants.class).in(Singleton.class);
        bind(BonusStyleNameConstants.class).in(Singleton.class);
        bind(ExternalStyleNameConstants.class).in(Singleton.class);
        bind(ChoiceStyleNameConstants.class).in(Singleton.class);
        bind(SimulationStyleNameConstants.class).in(Singleton.class);
        bind(SimpleTextStyleNameConstants.class).in(Singleton.class);
        bind(TutorStyleNameConstants.class).in(Singleton.class);
        bind(PlayerStyleNameConstants.class).in(Singleton.class);
        bind(IdentificationStyleNameConstants.class).in(Singleton.class);
        bind(MarkAnswersStyleNameConstants.class).in(Singleton.class);
        bind(OrderingStyleNameConstants.class).in(Singleton.class);
        bind(TextEditorStyleNameConstants.class).in(Singleton.class);
