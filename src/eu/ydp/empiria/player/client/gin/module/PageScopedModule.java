...
public class PageScopedModule extends AbstractGinModule{
	...
	protected void configure() {
		...
		bind(GroupedAnswersManager.class)
			.annotatedWith(PageScoped.class)
			.toProvider(GroupedAnswersManagerPageScopeProvider.class);
		
		bind(ModulesVariablesProcessorPageScopedProvider.class).in(Singleton.class);
		bind(ModulesVariablesProcessor.class)
			.annotatedWith(PageScoped.class)
			.toProvider(ModulesVariablesProcessorPageScopedProvider.class);
	}
