...
public class SwiffyObject {
	...
	private native void appendScriptsInIframe(String iframeId, String animationJsUrl, String runtimeUrl)/*-{
																										...
																										var scriptElementRt = createScript(ifrDoc, runtimeUrl, function() { that.@eu.ydp.empiria.player.client.components.animation.swiffy.SwiffyObject::onRuntimeJsLoaded()() } );
																										var scriptElementAnim = createScript(ifrDoc, animationJsUrl, function() { that.@eu.ydp.empiria.player.client.components.animation.swiffy.SwiffyObject::onAnimationJsLoaded()() } );
	...
	private native void createSwiffyObject(String iframeId, Element container)/*-{
																				...
																				iframe.contentWindow.swiffyStage = new iframe.contentWindow.swiffy.Stage(container, iframe.contentWindow.swiffyObject);
																				}-*/;
