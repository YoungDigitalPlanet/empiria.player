...
/**
 * This is needed to enable native events on media object. In other case sound can be heard, but will not produce any @HTML5MediaEventsType events. Panel is
 * hidden it because contains ugly, native controls.
 */
