...
public interface StickieFactory {
	...
	IStickiePresenter createStickiePresenter(IStickieProperties stickieProperties, StickieMinimizeMaximizeController minimizeMaximizeController, StickieRegistration stickieRegistration);
