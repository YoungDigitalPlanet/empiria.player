...
public class AreasMapsComparatorJUnitTest {
    ...
    public void findDifference_added() {
        ...
        Map<Area, ColorModel> current = ImmutableMap.of(new Area(1, 2), ColorModel.createFromRgba(0, 1, 2, 3), addedArea,
    ...
    public void findDifference_changed() {
        ...
        Map<Area, ColorModel> previous = ImmutableMap.of(new Area(1, 2), ColorModel.createFromRgba(0, 1, 2, 3), changedArea,
                ColorModel.createFromRgba(10, 11, 12, 13));
        Map<Area, ColorModel> current = ImmutableMap.of(new Area(1, 2), ColorModel.createFromRgba(0, 1, 2, 3), changedArea,
                ColorModel.createFromRgba(100, 101, 102, 103));
    ...
    public void findDifference_same() {
        // given
        Map<Area, ColorModel> oneMap = ImmutableMap.of(new Area(1, 2), ColorModel.createFromRgba(0, 1, 2, 3), new Area(11, 12),
                ColorModel.createFromRgba(10, 11, 12, 13));
    ...
    public void findDifference_removed() {
        ...
        Map<Area, ColorModel> previous = ImmutableMap.of(new Area(1, 2), ColorModel.createFromRgba(0, 1, 2, 3), removedArea,
                ColorModel.createFromRgba(10, 11, 12, 13));
