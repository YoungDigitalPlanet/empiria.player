...
public class ExpressionToPartsDividerJUnitTest {
	...
	private ExpressionToPartsDivider expressionToPartsDivider = new ExpressionToPartsDivider();
	
	@Test
	public void shouldDivideExpressionWhenEqualSignIsInTemplate() throws Exception {
	...
	@Test
	public void shouldCorrectlyDivideExpressionWhenEqualSignShouldComeFromResponse() throws Exception {
		String leftPart = "'a'";
		String rightPart = "'c'";
	...
	public void shouldThrowExceptionWhenCannotDivideExpression() throws Exception {
		String template = "'a'+'c'";
		...
		expressionToPartsDivider.divideExpressionOnEquality(template, responses);
	}
