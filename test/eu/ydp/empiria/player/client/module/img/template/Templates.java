...
public class Templates {
	...
	public final static String SCREEN_ELEMENT_WITH_CONTENT =
	...
	public final static String TEMPLATE_WITHOUT_FULLSCREEN_AND_CONTENT =
			"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\">"
					+ 		"<template>"
					+ 			"<div class=\"pict_f\">"
					...
					+ 				"<mediaScreen id=\"mediaScreen\"></mediaScreen>"
					+ 			"</div>"
					+ 		"</template>"
					+ "</img>";

	public final static String TEMPLATE_WITHOUT_CONTENT_WITH_FULLSCREEN =
					"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\" srcFullScreen=\"media/ilustracja_f.jpg\">"
					+ 		"<template>"
					+ 			"<div class=\"pict_f\">"
					+ 				"<mediaFullScreenButton id=\"mediaFullScreenButton\"></mediaFullScreenButton>"
					+ 				"<mediaDescription id=\"mediaDescription\"></mediaDescription>"
					...
					+ 		"</template>"
					+ "</img>";
	public final static String TEMPLATE_WITHOUT_CONTENT_WITH_DESCRIPTION =
			"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\" srcFullScreen=\"media/ilustracja_f.jpg\">"
			+ 		"<template>"
			+ 			"<div class=\"pict_f\">"
			+ 				"<mediaFullScreenButton id=\"mediaFullScreenButton\"></mediaFullScreenButton>"
			...
			+ 		"</template>"
			+ "</img>";
	public final static String TEMPLATE_WITHOUT_CONTENT_WITH_LABEL =
			"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\" srcFullScreen=\"media/ilustracja_f.jpg\">"
			+ 		"<template>"
			+			"<label/>"
			+ 			"<div class=\"pict_f\">"
			...
			+ 		"</template>"
			+ "</img>";
	public final static String TEMPLATE_WITH_CONTENT_WITHOUT_FULLSCREEN =
			"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\">"
					+ 		"<template>"
					+ 			"<div class=\"pict_f\">"
	...
	public final static String TEMPLATE_WITH_CONTENT_AND_FULLSCREEN =
					"<img id=\"dummy1_2\" class=\"pict_f title\" src=\"media/ilustracja.jpg\" srcFullScreen=\"media/ilustracja_f.jpg\">"
							+ 		"<template>"
							+ 			"<div class=\"pict_f\">"
							+ 				"<mediaFullScreenButton id=\"mediaFullScreenButton\">"
