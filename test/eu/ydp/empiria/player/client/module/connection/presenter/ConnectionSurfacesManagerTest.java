...
public class ConnectionSurfacesManagerTest {
	...
	public void before() throws Exception {
		connectedSurfaces = connectedSurfaces(testObj);
		surfaces = surfaces(testObj);
	...
	public void testHasConnections_trueForSource() {
		// when
		boolean actual = testObj.hasConnections("s3");
	...
	public void testHasConnections_trueForTarget() {
		// when
		boolean actual = testObj.hasConnections("t2");
	...
	public void testHasConnections_false() {
		// when
		boolean actual = testObj.hasConnections("n5");
	...
	public void testClearConnectionSurface_existing() {
		// when
		testObj.clearConnectionSurface(cpe2);
	...
	public void testClearConnectionSurface_nonExisting() {
		// when
		testObj.clearConnectionSurface(connectionPairEntry("nonExistingSource", "nonExistingTarget"));
	...
	public void testGetOrCreateSurface_existing() {
		...
		// when
		ConnectionSurface actual = testObj.getOrCreateSurface(key, mock(HasDimensions.class));
	...
	public void testGetOrCreateSurface_nonExisting() {
		...
		// when
		ConnectionSurface actual = testObj.getOrCreateSurface("otherId", hasDimension);
	...
	public void testRemoveSurfaceFromItem_existing() {
		...
		// when
		testObj.removeSurfaceForItem("someId");
	...
	public void testRemoveSurfaceFromItem_nonExisting() {
		...
		// when
		testObj.removeSurfaceForItem("otherId");
	...
	public void testFindPointOnPath_existing() {
		...
		// when
		ConnectionPairEntry<String, String> actual = testObj.findPointOnPath(new Point(0,0));
	...
	public void testFindPointOnPath_nonExisting() {
		// when
		ConnectionPairEntry<String, String> actual = testObj.findPointOnPath(new Point(1000,1000));
	...
	public void testContainsSurface_exisitng() {
		// when
		boolean actual = testObj.containsSurface(cpe3);
	...
	public void testContainsSurface_nonExisitng() {
		...
		// when
		boolean actual = testObj.containsSurface(cpe4);
	...
	public void testRemoveFromParent_existing() {
		// when
		testObj.removeSurfaceFromParent(cpe2);
	...
	public void testRemoveFromParent_nonExisting() {
		// when
		testObj.removeSurfaceFromParent(new ConnectionPairEntry<String, String>("abcd", "dcbe"));
	...
	private Map<ConnectionPairEntry<String, String>, ConnectionSurface> connectedSurfaces(ConnectionSurfacesManager obj) throws Exception {
		Field field = obj.getClass().getDeclaredField("connectedSurfaces");
		field.setAccessible(true);
		return (Map<ConnectionPairEntry<String, String>, ConnectionSurface>) field.get(obj);
	}

	@SuppressWarnings({ "unchecked" })
	private Map<String, ConnectionSurface> surfaces(ConnectionSurfacesManager obj) throws Exception {
		Field field = obj.getClass().getDeclaredField("surfaces");
		field.setAccessible(true);
		return (Map<String, ConnectionSurface>) field.get(obj);
	}
