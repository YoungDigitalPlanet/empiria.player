...
public class SelectionModulePresenterImplJUnitTest {
	...
	public void setUp() throws Exception {
		presenter = new SelectionModulePresenterImpl(selectionViewUpdater, answersMarker, selectionModuleView, model, viewBuilder, answersControllerModel);
	...
	public void tearDown() throws Exception {
		Mockito.verifyNoMoreInteractions(selectionModuleView, answersMarker, selectionModuleFactory, selectionViewUpdater, model, moduleSocket);
	}
	...
	public void testBindView() throws Exception {
		...
		when(viewBuilder.fillGrid(items, choices)).thenReturn(groupChoicesControllers);

		when(answersControllerModel.getGroupChoicesControllers()).thenReturn(groupChoicesControllers);
	...
	public void testMarkAnswers() throws Exception {
		...
		verify(selectionViewUpdater).updateView(Matchers.any(SelectionModuleView.class), Matchers.any(GroupAnswersController.class), Matchers.anyInt());
	}
