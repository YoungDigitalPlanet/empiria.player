...
public class GroupAnswersControllerModelTest {
	...
	public void testGetSelectedAnswers() throws Exception {
		...
		//when
		when(groupController1.getSelectedAnswers())
			.thenReturn(selectedAnswers1);

		when(groupController2.getSelectedAnswers())
			.thenReturn(selectedAnswers2);
	...
	public void testGetNotSelectedAnswers() throws Exception {
		...
		//when
		when(groupController1.getNotSelectedAnswers())
			.thenReturn(notSelectedAnswers1);

		when(groupController2.getNotSelectedAnswers())
			.thenReturn(notSelectedAnswers2);
