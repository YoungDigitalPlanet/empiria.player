...
public class MultipleModeVariableProcessorJUnitTest {
	...
	public void setUp() throws Exception {
		multipleModeVariableProcessor = new MultipleModeVariableProcessor(errorAnswersCounter, correctAnswersCounter, lastGivenAnswersChecker, multipleModeAnswersEvaluator);
	}
	...
	public void shouldCountErrors() throws Exception {
		...
		when(errorAnswersCounter.countErrorAnswersAdjustedToMode(response))
			.thenReturn(amountOfErrros);
	...
	public void shouldCountDone() throws Exception {
		...
		when(correctAnswersCounter.countCorrectAnswersAdjustedToCountMode(response))
		.thenReturn(amountOfDone);
	...
	public void shouldEvaluateAnswers() throws Exception {
		...
		when(multipleModeAnswersEvaluator.evaluateAnswers(response))
