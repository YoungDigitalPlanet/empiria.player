...
public class MultipleModeAnswersEvaluatorJUnitTest {
	...
	public void shouldEvaluateAnswersInUserMode() throws Exception {
		Response response = builder().withEvaluate(Evaluate.USER)
				.withCorrectAnswers("correct1", "correct2")
				.withCurrentUserAnswers("correct2", "wrong")
				.build();
	...
	public void shouldEvaluateAnswersInDefaultMode() throws Exception {
		Response response = builder().withEvaluate(Evaluate.DEFAULT)
				.withCorrectAnswers("correct1", "correct2")
				.withCurrentUserAnswers("correct2", "wrong")
				.build();
