...
public class ItemJsonReportTest extends AbstractEmpiriaPlayerGWTTestCase {
	...
	public void testGeneratingJSON(){
		...
		assertEquals("JSON String", "{\"index\":1, \"title\":\"Item title\", \"result\":{\"todo\":2, \"done\":3}, \"hints\":{\"errors\":2, \"mistakes\":3}}", item.getJSONString());
	}
