...
public enum TestMediaAudio implements TestMedia {
	...
	SINGLE_MP3_0(MapCreator.create("sound0.mp3", "audio/mp3").build(), false),
	SINGLE_MP3_1(MapCreator.create("sound1.mp3", "audio/mp3").build(), false),
	SINGLE_OGG_0(MapCreator.create("sound0.ogg", "audio/ogg").build(), false),
	SINGLE_OGG_1(MapCreator.create("sound1.ogg", "audio/ogg").build(), false),
	MULTI_MP3_OGG(MapCreator.create("sound0.mp3", "audio/mp3").put("sound0.ogg", "audio/ogg").build(), false);
