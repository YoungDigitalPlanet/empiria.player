...
public class InlineFeedback extends PopupPanel implements IItemFeedback {
	...
	public native void fadeInJs(com.google.gwt.dom.client.Element element, int fadeEffectTime)/*-{
		var instance = this;
	    var _this = element;
	    this.@eu.ydp.empiria.player.client.controller.feedback.InlineFeedback::opacityto(Lcom/google/gwt/dom/client/Element;I)(_this, 0);
	    ...
	    for (i = 0; i <= 100; i+=5) {
	      (function(j) {
	            setTimeout(function() {  
	                  instance.@eu.ydp.empiria.player.client.controller.feedback.InlineFeedback::opacityto(Lcom/google/gwt/dom/client/Element;I)(_this, j);
	                  },j*delay/100);
